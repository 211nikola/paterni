 ...
 * @author Nikola
 */
public class Kontroler22 extends Kontroler_a{
    
    public Kontroler22(EkranskaForma ef1,BrokerBazePodataka bbp1){
        ef=ef1;bbp=bbp1; Povezi(null);
    }
    ...
    public void Povezi(Kontroler_a kon) {
        ...
        Kreiraj.addActionListener( new Kontroler22.OsluskivacKreiraj(this));
        Promeni.addActionListener( new Kontroler22.OsluskivacPromeni(this));
        Obrisi.addActionListener( new Kontroler22.OsluskivacObrisi(this));
        Nadji.addActionListener( new Kontroler22.OsluskivacNadji(this));
        
        javax.swing.JTextField SifraPrijave = ef.getPanel().getSifraPrijave1(); // Promenljivo!!!
        SifraPrijave.addFocusListener( new Kontroler22.OsluskivacNadji1(this));
...
{ ef.getPanel().setPoruka(poruka);
  ...
  public void run() {
    ...
    if (signal==true) 
        ...
        poruka ="Sistem ne moze da kreira novog clana."; 
        }
    prikaziPoruku();
    bbp.closeConnection();
    return signal;
    ...
    if (signal==true) 
        ...
        { bbp.rollbackTransation();
          isprazniGrafickiObjekat();
          poruka = "Sistem ne moze da promeni clana."; 
        }
    prikaziPoruku();
    bbp.closeConnection();
    return signal;      
    ...
    OsluskivacZapamti(Kontroler22 kon1) {kon = kon1;}
...
{   Kontroler22 kon;
    ...
    OsluskivacKreiraj(Kontroler22 kon1) {kon = kon1;}
...
class OsluskivacObrisi implements ActionListener{ 
    ...
    OsluskivacObrisi(Kontroler22 kon1) {kon = kon1;}
...
class OsluskivacPromeni implements ActionListener{
    ...
    OsluskivacPromeni(Kontroler22 kon1) {kon = kon1;}
...
class OsluskivacNadji implements ActionListener{
    ...
    OsluskivacNadji(Kontroler22 kon1) {kon = kon1;}
...
class OsluskivacNadji1 implements FocusListener{  
    ...
    OsluskivacNadji1(Kontroler22 kon1) {kon = kon1;}
