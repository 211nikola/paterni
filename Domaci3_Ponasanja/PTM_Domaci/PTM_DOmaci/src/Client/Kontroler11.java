...
public final class Kontroler11 extends Kontroler_a{
    ...
    void Povezi()
    {
      ConcreteClass.KreirajDomenskiObjekat kdo = new ConcreteClass.KreirajDomenskiObjekat(bbp,this); 
      Dugme dk1 = new Dugme(kdo,ef.getPanel().getKreiraj()); 
      
      ConcreteClass.PromeniDomenskiObjekat pdo = new ConcreteClass.PromeniDomenskiObjekat(bbp,this);
      Dugme dk2 = new Dugme(pdo,ef.getPanel().getPromeni());
      
      ConcreteClass.ObrisiDomenskiObjekat odo = new ConcreteClass.ObrisiDomenskiObjekat(bbp,this);
      Dugme dk3 = new Dugme(odo,ef.getPanel().getObrisi());
      
      ConcreteClass.NadjiDomenskiObjekat ndo = new ConcreteClass.NadjiDomenskiObjekat(bbp,this);
